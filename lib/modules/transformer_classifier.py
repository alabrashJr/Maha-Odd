...
class TransformerClassifier(Module):
    ...
    def forward(self, seq=None, att_idxs=None, inputs_embeds=None):
        ...
        self.feats = bert_feats[1] # n*768
        pooled_output = self.dropout(self.feats)
        return self.classifier(pooled_output) #n*labels
...
class TransformerModule(LightningModule):
    ...
    def training_epoch_end(self, outputs):
        ...
        if 'train_accuracy' not in outputs[0]:
            outputs = [x['log'] for x in outputs]
